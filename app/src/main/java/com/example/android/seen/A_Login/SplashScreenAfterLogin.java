...
public class SplashScreenAfterLogin extends AppCompatActivity {
	 ...
	 protected void onCreate(Bundle savedInstanceState) {
		  ...
		  Bar();
		  setContentView(R.layout.activity_splash_screen_after_login);
		  ...
		  new Handler().postDelayed(new Runnable() {
			   ...
			   public void run() {
					...
					Intent i = new Intent(SplashScreenAfterLogin.this, adsActivity.class);
					startActivity(i);

					 finish();
			   }
		  }, 1000); /** Number Of Second Until go the Activity loginActivity */
	 }
